 ...
 * @LastEditors: Mr.Hope
 * @LastEditTime: 2019-09-25 07:27:17
 * @Description: 捐赠
 */
...
$register('donate', {
  data: {
    ...
    page: [
      ...
      {
        tag: 'p',
        text: '   如果您愿意对我进行捐赠，可以点击下方二维码。这样会将对应的二维码保存至您的手机相册。您可以稍后使用相应APP扫码来进行打赏。因为您也是学生，Mr.Hope不建议您捐赠数目较大的金额，几分钱也是同学一份心意。为了方便统计，请您在打赏时备注“小程序打赏+ 昵称/姓名”，这样能够方便Mr.Hope统计。Mr.Hope会将每一笔捐赠的姓名和打赏金额显示在下方的列表中。再次感谢您的支持！'
      }
    ]
  },
  onLoad() {
