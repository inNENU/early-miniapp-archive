 ...
 * @LastEditTime: 2019-06-22 20:50:32
 */
 ...
 */
const readJson = (path, encoding = 'utf-8') => {
  let fileContent;
  let data;
 ...
 * @return {void}
 */
const makeDir = (path, recursive = true) => {
  try {
 ...
 * @return {void}
 */
const saveFile = (tempFilePath, path) => {
  try {
 ...
 * @return {void}
 */
const saveOnlineFile = ([onlinePath, savePath, fileName], successFunc, failFunc, errorFunc) => {
  makeDir(savePath);
  wx.downloadFile({
 ...
 * @return {void}
 */
const writeFile = (path, fileName, data, encoding = 'utf-8') => {
 ...
 * @return {void}
 */
const writeJson = (path, fileName, data, encoding = 'utf-8') => {
  const jsonString = JSON.stringify(data);
 ...
 * @returns {void}
 */
const getJson = (path, callback, failFunc) => {
 ...
 * @return {void}
 */
const unzip = (path, unzipPath, callback, ...args) => {
  fileManager.unzip({
