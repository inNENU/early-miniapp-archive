...
Page({
  data: {
    page: [
      { tag: 'head', title: 'V0.3开发日志', grey: true },
      ...
      { tag: 'p', head: 'V0.3.6', text: '移除pages本地内容改为在线加载；\n利用服务器缓存json，进入页面的时候直接从服务器加载；' },
      { tag: 'p', head: 'V0.3.7', text: '首次进入页面从服务器加载，第二次调用本地缓存节省流量；' },
      { tag: 'p', head: 'V0.3.8', text: '再度精简了界面初始代码；' },
      { tag: 'p', head: 'V0.3.9', text: '改进了页面Onload代码；引入showloading组件指示下载进度；' },
      { tag: 'p', head: 'V0.3.10', text: '适配了study界面和dorm界面，在设置里添加了提示开关；' },
      { tag: 'foot' },
    ],
  },
