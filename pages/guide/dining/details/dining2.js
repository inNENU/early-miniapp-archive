...
Page({
  data: {
    page: [
      { name: 'head', title: '南苑餐厅' },
      { name: 'h3', text: '一楼——特色档口' },
      { name: 'p', head: false, text: '南苑一楼有各种档口，有包子、面条、炒饭，另外还有清真食物档口等，味道比较好，价位适中。' },
      { name: 'img', src: 'https://pic.kuaizhan.com/g1/M01/6C/A9/CgpQU1l8N0KAWiQ5AAN0qjh1IaY1618944/imageView/v1/thumbnail/640x480' },
      { name: 'img', src: 'https://pic.kuaizhan.com/g1/M00/8F/E8/wKjmqVl8Nv2AIgsxAC8uKlgD3b40781391/imageView/v1/thumbnail/640x480', text: '南苑一楼' },
      { name: 'h3', text: '二楼' },
      { name: 'p', head: false, text: '南苑二楼为基本餐区，分时间段供应食物，价位比较亲民。' },
      { name: 'p', head: '供应时间', text: '早餐供应时间为：6:30-8:30。午餐供应时间为：10：30-12：30。晚餐供应时间为：16：30-18：00' },
