...
Page({
  data: {
    page: [
      ...
      { name: 'img', src: 'https://pic.kuaizhan.com/g2/M00/7F/1F/CgpQVFl8LnKAdPG8AABlG0iPvGo9169624/imageView/v1/thumbnail/640x0', text: '▲图为北苑餐厅正门门厅' },
      { name: 'h4', text: '基本餐供应时间' },
      ...
      { name: 'p', text: '' },
      { name: 'h3', text: '一楼南侧档口' },
      { name: 'h4', text: '添加档口详细信息（档口卖什么）再加点图。' },
