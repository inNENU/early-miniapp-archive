...
Page({
  data: {
    page: [
      ...
      { name: 'h3', text: '基本餐' },
      { name: 'p', head: '基本餐价格', text: '米饭￥0.25/两；\n素菜￥1—￥2.5，荤菜￥2.5—￥3.5。' },
      ...
      { name: 'img', src: 'https://pic.kuaizhan.com/g1/M00/6C/A0/CgpQU1l8LpOAMi19AACoaWWW_IU6360955/imageView/v1/thumbnail/640x480', text: '早餐主食区' },
      { name: 'p', head: false, text: '午餐供应时间为：11:00-12:30\n晚餐供应时间为：16:30-18:00\n' },
      { name: 'img', src: 'https://pic.kuaizhan.com/g2/M01/7F/21/CgpQVFl8MNuAe_HxAAEWIvTNzlY7442671/imageView/v1/thumbnail/640x480', text: '餐盘餐具' },
      { name: 'img', src: 'https://pic.kuaizhan.com/g1/M01/8F/E1/wKjmqVl8MNyAdHDAAAEap3hwtMA9244954/imageView/v1/thumbnail/640x480', text: '荤菜区' },
      ...
      { name: 'img', src: 'https://pic.kuaizhan.com/g2/M00/80/DE/wKjmqll8MVmASgnWAANAnzRXmpc5298797/imageView/v1/thumbnail/640x480', text: '北苑一楼南侧' },
      { name: 'foot' },
    ],
  },
