...
Page({
  data: {
    page: [
      ...
      { name: 'list', content: [{ text: '北苑餐厅', url: 'details/dining1' }, { text: '南苑餐厅', url: 'details/dining2' }] },
      { name: 'h2', text: '净月校区' },
      { name: 'p', text: '净月校区有两个食堂，分别为中快食堂和二食堂，中快食堂有三层、二食堂有两层。中快餐厅共三层楼，每一层楼有自己的特色。' },
      { name: 'list', content: [{ text: '中快餐厅', url: 'details/dining4' }, { text: '二食堂', url: 'details/dining5' }] },
      { name: 'h2', text: '美食节' },
