...
{ name: 'h3', text: '理发' },
      {
        name: 'p', text: '本部：浴池二楼净月：二食堂楼下（书店、水果店旁）、浴池外洗衣房旁' },
{ name: 'h3', text: '照相' },
{ name: 'p', text: '本部：浴池一楼；北苑复印店（但是他们家主营打印复印，而且比较忙……）净月：二食堂楼下（书店、水果店旁）、二食堂一楼超市对面' },
{ name: 'h3', text: '打印' },
      {
        name: 'p', text: '本部打印店分布于:浴池二楼、北苑超市旁、南苑、图书馆一楼、图书馆电子阅览室、师训大楼一楼（现搬至北苑地下一楼）净月打印店有：二食堂超市对面复印店、师大图文复印店' },
