...
Page({
  data: {
    page: [{ name: 'head', title: '特殊说明' },
    { name: 'h3', text: '特殊说明' }, { name: 'p', text: '1．国家励志奖学金由资助中心评定，需为学校确定的资助对象中品学兼优的学生。其余奖学金由学生处评定。' }
      ...
      , {
        name: 'p', text:'7．有以下情况者，原则上不能参加各项评奖评优（1）本学年受处分的学生；（2）恶意欠交学费的学生；（3）来我校学习的交流生；（4）评奖学年出现挂科的学生（不含单项奖学金）'}
      , { name: 'p', text: '8．优秀学生从获得国家奖学金、校长奖学金、一等奖学金的学生中产生。'}
      , { name: 'p', text: '9．原则上单项奖学金（含少数民族齐飞奖）要求专业课成绩不挂科或挂科数不超过1门：每人每年获单项奖学金不得超过两项。'}
      , { name: 'p', text: '10．具体情况见附件。 注意：附件不能在小程序中直接打开，请复制链接后在浏览器进行操作。附件下载网址：https://pan.baidu.com/s/1i5gOGeh'}
