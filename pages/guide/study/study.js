...
Page({
  data: {
    page: [
      ...
      { name: "h2", text: "图书馆" }, { text: "list", content: [{ text: "图书馆风貌", url: "details/learning24" }, { text: "馆藏分布", url: "details/learning25" }, { text: "图书馆开门时间", url: "details/learning26" }, { text: "借书权限", url: "details/learning27" }, { text: "其他服务", url: "details/ learning28" }, { text: "注意事项", url: "details/ learning29" }] }, { name: "h2", text: "" },
