...
Page({
  data: {
    page: [
      ...
      { name: 'img', src: 'https://pic.kuaizhan.com/g2/M00/82/46/wKjmqll9eqOABFZDAAEMTXxnJU81957452/imageView/v1/thumbnail/640x0' },
      { name: 'n', text: '▲图为' },
      { name: 'img', src: 'https://pic.kuaizhan.com/g2/M00/82/46/wKjmqll9epWAPec_AACsw24QesA6899428/imageView/v1/thumbnail/640x0' },
      { name: 'n', text: '▲图为' },
      { name: 'h3', text: '秋华公寓' },
