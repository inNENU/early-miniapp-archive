...
Page({
  data: {
    page: [
      { tag: 'head', title: '学生资助机构' },
      { tag: 'h3', text: '学生资助管理中心' },
      { tag: 'p', text: '负责全校家庭经济困难学生资助工作的专门机构，为家庭经济困难学生提供全面的财力支持和素质支持。下设资助办公室、贷款办公室、综合办公室三个科室' },
